...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new io.widgetlib.emoji_picker_2.EmojiPicker2Plugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin emoji_picker_2, io.widgetlib.emoji_picker_2.EmojiPicker2Plugin", e);
    }
    try {
